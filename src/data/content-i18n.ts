...
const zhConcertOverrides: Partial<Record<string, Partial<LocalizedConcert>>> = {
  "henan-piano-masterclass-jul-2026": {
    title: "《练琴的时候，我们在练什么？》公益讲座与大师课",
    venue: "河南艺术中心·小剧场",
    address: "中国河南郑州",
    description:
      "从手指训练到音乐思维：本次公益讲座与大师课将从具体谱例和日常练习实践出发，重新审视“练琴”这一行为本身，探讨如何从机械重复走向音乐思维、在练习中建立清晰的听觉判断，并通过“听见自己”的演奏过程逐渐成为“自己的老师”。\n\n河南艺术中心会员可免费实名预约，每人限约一张，儿童也需预约入场。预约电话：0371-69092200，名额有限。",
  },
  "henan-east-west-jul-2026": {
    title: "境·界——钢琴中的东方与西方音乐会",
    venue: "河南艺术中心·音乐厅",
    address: "中国河南郑州",
    description:
      "钢琴诞生于西方，却不断成为承载不同文化想象与审美精神的媒介。本场音乐会以“境·界——钢琴中的东方与西方”为题，选取中国与欧洲作曲家笔下风格迥异却彼此呼应的作品。\n\n音乐会以“舞、叙、景、戏”四重意象为线索，探索钢琴如何超越语言与地域，在不同文化传统之间构建共通的感知空间。",
    program: [
      "康拉迪 / 李斯特：《吉普赛波尔卡》S.481/R.146",
      "孙以强：《谷粒飞舞》",
      "黎英海：《夕阳萧鼓》",
      "韦伯 / 李斯特：《辉煌波兰舞曲》S.455/R.460",
      "中场休息",
      "王建中改编：《彩云追月》",
      "李斯特：《瓦伦施塔特湖畔》S.160/6",
      "张朝：《皮黄》",
